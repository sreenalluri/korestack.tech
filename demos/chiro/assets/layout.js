/* =============================================================================
   layout.js — shared chrome for every True North Chiropractic page.

   Same pattern as the Lumen Dental demo: header + footer rendered from a
   single source of truth so nav stays identical across pages. Each page needs:
...
(function () {
  ...
  var BIZ = {
    ...
    address: "3800 McKinney Ave, Suite 240",
    city: "Dallas, TX 75204",
  };

  // Brand mark — compass needle pointing true north (kept in sync with favicon.svg).
  var MARK =
    '<svg class="brand__mark" viewBox="0 0 64 64" aria-hidden="true">' +
      '<defs><linearGradient id="brandLg" x1="0" y1="0" x2="1" y2="1">' +
        '<stop offset="0" stop-color="#6f9165"/><stop offset="1" stop-color="#43613d"/>' +
      '</linearGradient></defs>' +
      '<rect width="64" height="64" rx="16" fill="url(#brandLg)"/>' +
      '<circle cx="32" cy="32" r="19" fill="none" stroke="#fff" stroke-opacity=".35" stroke-width="2.5"/>' +
      '<path fill="#fff" opacity=".96" d="M32 12l6.5 17.5L32 26l-6.5 3.5z"/>' +
      '<path fill="#dcE8d4" opacity=".85" d="M32 52l-6.5-17.5L32 38l6.5-3.5z"/>' +
    '</svg>';

  // Absolute paths (site is served with trailingSlash:false — see dental demo).
  var BASE = "/demos/chiro/";
    ...
    host.innerHTML =
      '<nav class="nav" aria-label="Primary">' +
        '<a class="brand" href="' + BASE + 'index.html" aria-label="' + BIZ.name + ' home">' +
          MARK +
          '<span class="brand__word">True North<b>.</b>' +
            '<span class="brand__sub">Chiropractic</span>' +
          "</span>" +
        "</a>" +
    ...
    host.innerHTML =
      '<div class="container">' +
        '<div class="footer-grid">' +
          '<div class="footer-brand">' +
            '<a class="brand" href="' + BASE + 'index.html" aria-label="' + BIZ.name + ' home">' + MARK +
              '<span class="brand__word" style="color:#fff">True North<b>.</b></span>' +
            "</a>" +
            "<p>Calm, evidence-based chiropractic care in Uptown Dallas. Gentle adjustments, honest plans, and a team that helps you stand tall again.</p>" +
          ...
          '<div class="footer-col">' +
            "<h4>Care</h4>" +
            '<a href="' + BASE + 'services.html#adjustments">Spinal Adjustments</a>' +
            '<a href="' + BASE + 'services.html#decompression">Decompression</a>' +
            '<a href="' + BASE + 'services.html#sports">Sports Rehab</a>' +
            '<a href="' + BASE + 'services.html#massage">Massage Therapy</a>' +
            '<a href="' + BASE + 'services.html#posture">Posture Correction</a>' +
          "</div>" +
          '<div class="footer-col">' +
            "<h4>Practice</h4>" +
        ...
        '<div class="footer-demo-note">' +
          "<b>Demo notice:</b> True North Chiropractic is a fictional practice built by " +
          '<a href="/" style="color:#b9d6ab">Korestack</a> to showcase a modern chiropractic website. ' +
          "All names and reviews are simulated — no real patient data." +
        "</div>" +
        '<div class="footer-bottom">' +
          "<span>© " + y + " " + BIZ.name + " — a Korestack demo. All rights reserved.</span>" +
          '<span><a href="#">Privacy</a> · <a href="#">Accessibility</a></span>' +
        "</div>" +
      "</div>";
  }
